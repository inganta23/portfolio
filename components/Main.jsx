      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <p className="text-gray-600 py-4 max-w-[70%] m-auto">
            I am graduates of Computer Science from Universitas Sumatera Utara.
            Currently, I'm focused on mastering backend technologies.
          </p>
          <div className="flex items-center justify-between max-w-[330px] m-auto py-4">
            ...
            <div className="rounded-full shadow-lg shadow-gray-400 p-6 cursor-pinter hover:scale-110 ease-in duration-300">
              <a
                href="https://github.com/inganta23"
                target="_blank"
                rel="noreferrer"
              >
                <FaGithub />
            ...
            <div className="rounded-full shadow-lg shadow-gray-400 p-6 cursor-pinter hover:scale-110 ease-in duration-300">
              <a
                href="https://wa.me/+6281218191202"
                target="_blank"
                rel="noreferrer"
              >
